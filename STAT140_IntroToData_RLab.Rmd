...
Note that we could accomplish the same thing using the ggplot() function from the ggplot2 package. In the chunk below, make the same plot using ggplot().
...
Note that we could accomplish the same thing using the ggplot() function from the ggplot2 package. In the chunk below, make the same plot using ggplot(). You will need to use the total variable from the arbuthnot data, rather than the sum of boys and girls for ggplot().
